...
const menuItems = [
  ...
  { icon: BookOpen, label: "Protocolo", path: "/protocol" },
  { icon: Calculator, label: "Calculadora BSA", path: "/calculator" },
  { icon: Heart, label: "Cardio-Oncologia", path: "/cardio-oncology" },
  { icon: Activity, label: "Monitoramento", path: "/monitoring" },
  { icon: AlertTriangle, label: "CTCAE v5.0", path: "/ctcae" },
  { icon: Zap, label: "Interações", path: "/interactions" },
